...
export const AppReducer = (state = InitialState, action) => {
  ...
  case Actions.ReactorLevelChangeTimer:
    return {
      ...state,
      ReactorLevelChangeTimer: action.ReactorLevelChangeTimer,
    }
  ...
  case Actions.ChangeSteam:
    ...
    const ReactorLevelChange = CalcSteam.ReactorLevelChange(SteamPressure, state.ReactorLevelChange)
